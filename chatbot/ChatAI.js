...
class ChatAI {
    ...
    constructor(options) {
        let defaults = {
            api_key: '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',
            source: 'openai',
            model: 'gpt-3.5-turbo',
            conversations: [],
    ...
    _welcomePageTemplate() {
        return `
            <div class="welcome">
                <h1>Custom Chatbot 1.0</h1>                    
                <p>Crafted for innovation by <a href="https://grazitti.com" target="_blank">Grazitti Interactive</a></p>
